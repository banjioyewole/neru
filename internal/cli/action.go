...
// ActionSelectHintCmd selects the hint matching a spoken/typed word.
var ActionSelectHintCmd = BuildSelectHintCommand()
...
func init() {
	...
	ActionCmd.AddCommand(ActionSelectHintCmd)
